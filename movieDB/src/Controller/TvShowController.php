...
class TvShowController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('tv_show_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('tv_show/new.html.twig', [
            'tv_show' => $tvShow,
            'form' => $form,
        ]);
    }
    ...
    public function edit(Request $request, TvShow $tvShow): Response
    {
        ...
        return $this->renderForm('tv_show/edit.html.twig', [
            'tv_show' => $tvShow,
            'form' => $form,
        ]);
    }
